...
function decodeFilename1(filename){
    let parts = filename.split('_')
    let rightPart = parts.slice(1).join()
    let finalParts = rightPart.split('.')
    finalParts.pop()
    return finalParts.join('.')
}

function decodeFilename2(texto){
...
console.log(decodeFilename2('2023122512345678_sleighDesign.png.grinchwa'))